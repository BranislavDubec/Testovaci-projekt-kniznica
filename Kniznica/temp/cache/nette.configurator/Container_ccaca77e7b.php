<?php
// source: C:\Users\dubec\Desktop\Testovaci-projekt-kniznica\Kniznica/config/common.neon
// source: C:\Users\dubec\Desktop\Testovaci-projekt-kniznica\Kniznica/config/local.neon
// source: array
...
class Container_ccaca77e7b extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\Users\dubec\Desktop\Testovaci-projekt-kniznica\Kniznica/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\Users\dubec\Desktop\Testovaci-projekt-kniznica\Kniznica/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'C:\Users\dubec\Desktop\Testovaci-projekt-kniznica\Kniznica/temp/cache',
			$this->getService('cache.journal')
		);
	}


	public function createServiceContainer(): Container_ccaca77e7b
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=library', 'root', 'axinko', []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_ccaca77e7b $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\Users\dubec\Desktop\Testovaci-projekt-kniznica\Kniznica/temp/cache/latte');
